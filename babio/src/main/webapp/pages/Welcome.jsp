...
function receiveOutput(){
			...
			try{
				...
				//alert("reqFeature.readyState: "+reqFeature.readyState);
				if (reqFeature.readyState <= 4){ // Complete	
						...
						{ // OK response
							...
							if(xmlhtp.indexOf("mg/100ml") > -1 || xmlhtp.indexOf("mg/100mL") > -1)
							{
								...
								if((xmlhtp.indexOf("KATS") > -1) || (xmlhtp.indexOf("ALPHA") > -1))
								{
									...
									var resfordisplaytemp=xmlhtp.substring(xmlhtp.indexOf("TAYAL")).replace(/^\s*[\r\n]/gm, "");
								...
								}else if(xmlhtp.indexOf("TAYALTECH") > -1)
								{
									...
									res = res.replace(strtobereplaced,newdatetime);
									var resfordisplaytemp;
									if(xmlhtp.indexOf("image64:")>-1){
									var resfordisplaytemp=xmlhtp.substring(xmlhtp.indexOf("TAYAL"),xmlhtp.indexOf("image64:")).replace(/^\s*[\r\n]/gm, "");
									}
									else{
									resfordisplaytemp=xmlhtp.substring(xmlhtp.indexOf("TAYAL")).replace(/^\s*[\r\n]/gm, "");
									}
									resfordisplay=resfordisplaytemp.replace(strtobereplaced,newdatetime);   
									
									

								}else if(xmlhtp.indexOf("PREKSHA") > -1)
								{
									
									res=xmlhtp.substring(xmlhtp.indexOf("PREKSHA"));
									var today = new Date();
									...
									//var resfordisplaytemp=xmlhtp.substring(xmlhtp.indexOf("PREKSHA"),xmlhtp.indexOf("image64:")).replace(/^\s*[\r\n]/gm, "");
									//var resfordisplaytemp=xmlhtp.substring(xmlhtp.indexOf("PREKSHA")).replace(/^\s*[\r\n]/gm, "");
									if(xmlhtp.indexOf("image64:")>-1){
										var resfordisplaytemp=xmlhtp.substring(xmlhtp.indexOf("PREKSHA"),xmlhtp.indexOf("image64:")).replace(/^\s*[\r\n]/gm, "");
										}
										else{
										resfordisplaytemp=xmlhtp.substring(xmlhtp.indexOf("PREKSHA")).replace(/^\s*[\r\n]/gm, "");
										}
									resfordisplay=resfordisplaytemp.replace(strtobereplaced,newdatetime);   
								...
								if(res1 > 0)
								{
									...
									//CHANGES START
									//setTimeout(function(){
										//document.getElementById("result").innerHTML="<table bgcolor='red'><tr><td><img src='" + picurl + "'/></td><td> <textarea rows='11' cols='30' style='background-color: red'>" + resfordisplay + " </textarea></td></tr></table>";},3000);
								...
								{  
								    ...
								    //CHANGES START
									//setTimeout(function() {
    									//document.getElementById("result").innerHTML="<table><tr><td><img src='" + picurl + "'/></td><td> <textarea style='font-size : 12pt' rows='11' cols='30'>" + resfordisplay + " </textarea></td></tr></table>";}, 3000);
									document.forms[0].barepeat.value="false";
									//CHANGES OVER
								}

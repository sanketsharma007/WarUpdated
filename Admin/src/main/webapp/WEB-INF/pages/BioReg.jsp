...
<table   style="height:100%; width:100%; " border="0" align="center" cellpadding="1">
			...
			<table   style="height:100%; width:100%; " border="0" align="center" cellpadding="1">
				<tr style="background-color: #84c754;">					
					...
					<td style="height:10%; width:60%;"align="center" >
								<h1>Finger Print Registration</h1> 			
					</td>
					<td style="height:10%; width:20%;"align="center" >
	...
	<tr >					
		<td style="height:10%; width:100%;" align="center" >
			...
			<textarea  id="output"  cols="100" rows="1" style="border:0;  text-align:center;">Select a finger to register and click on register.	</textarea>   
	    </td>									
	</tr>
...
function BioReg()
{
	...
	document.getElementById("output").innerHTML="Please place your finger on the sensor";

	if(document.forms[0].method.value == "Return")
		{
		 window.opener.postMessage({ message: "Registration Successfull", result: true }, "*");
		}
	else
		{
		
		
		var url="welcome.do?method=BioReg&finger="+ document.forms[0].finger.value;
			...
			try{
				...
				if (reqFeature.readyState == 4){ // Complete					
						...
						{ // OK response
							...
							if(xmlhtp.indexOf("Registration Complete") > -1)
								{
